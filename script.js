const supabase = window.supabase.createClient(
  ...
  function showProjectDetailsModal(project) {
    ...
    projectImage.src = project.image || 'default-image.jpg'; // Use a default image if none is provided
    projectImage.alt = project.title;

    // Add click handlers for AI assistants
        ...
        link.onclick = function(event) {
            ...
            navigator.clipboard.writeText(textToCopy).then(() => {
                ...
                try {
                    ...
                    console.error('Failed to copy details. Please manually copy.');
                }
